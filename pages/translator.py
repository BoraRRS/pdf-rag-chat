...
def detect_language(text: str, model_name: str) -> str:
    ...
    # Karar verme mantığı
    if azeri_score >= min_threshold and azeri_score > turkish_score and azeri_score > english_score:
        return "Azerbaycan Türkçesi"
    elif turkish_score >= min_threshold and turkish_score > azeri_score:
        return "Türkçe"
    elif english_score >= min_threshold:
        return "İngilizce"
    elif arabic_score >= min_threshold:
        return "Arapça"
